...
import feedparser
from sentinel_safe_requests import safe_get  # 🛡️ Sentinel: SSRF Protection
...
def fetch_rss_data(known_links):
    ...
    for feed_config in feeds:
        ...
        try:
            # 🛡️ Sentinel: Use safe_get to prevent SSRF
...
def enrich_candidates(candidates):
    ...
    for item in candidates:
        ...
        try:
            # 🛡️ Sentinel: Use safe_get for Jina AI requests too

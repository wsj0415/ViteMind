...
def distill_wisdom(articles):
    ...
    **筛选标准（优先关注）：**
    ...
    model = genai.GenerativeModel(
        ...
        # Safety settings: block few things to avoid over-censorship of news
        safety_settings={
    ...
    for attempt in range(max_retries):
        try:
            ...
            # Clean up potential markdown code blocks just in case, though mime_type=json usually avoids it
...
if __name__ == "__main__":
    ...
    print("--- Starting Artisan News Generator (Gemini Edition) ---")
